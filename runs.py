...
def main(args):
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            log = kge_model.train_step(
                kge_model, optimizer, train_iterator, args, use_cuda=args.cuda)
            ...
            if args.do_valid and step % args.valid_steps == 0:
                ...
                metrics = kge_model.test_step(kge_model, data_reader, ModeType.VALID, args, use_cuda=True)
    ...
    if args.do_test:
        ...
        metrics = kge_model.test_step(kge_model, data_reader, ModeType.TEST, args, use_cuda=True)
